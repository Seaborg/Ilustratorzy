class Pic < ActiveRecord::Base
  ...
  validates_attachment_content_type :photo, :content_type=>['image/jpeg','image/pjpeg','image/png','image/x-png'], :message=>'Format pliku musi być: .jpeg albo .png'
  validates_attachment_size :photo, :less_than => 2.megabytes, :message=>'Grafika musi być wielkości 2 MB albo mniejsza.'       
  ...
  validates_presence_of :user_id, :on => :create, :message => "Musisz być zalogowany."
