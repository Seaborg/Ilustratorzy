class UsersController < ApplicationController
    ...
    def post_to_wall
      ...
      if @user.friends.include?(@author) || @user == @author
        ...
        flash[:notice] = "Możesz wysłać swój post tylko na ścianie użytkowników którzy podążyli za Tobą."
      end
      redirect_to @user
    end
    ...
    def create
      ...
      if @user.save_without_session_maintenance
        ...
        flash[:notice] = "Rejestracja przebiegła poprawnie. Sprawdź swojego maila, żeby potwierdzić rejestrację"
    ...
    def update
      ...
      if @user.update_attributes(params[:user])
        flash[:notice] = "Konto zaktualizowane!"
